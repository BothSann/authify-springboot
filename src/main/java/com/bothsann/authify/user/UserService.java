 ...
 * admin-facing endpoints (list all users, delete a user). Both {@link UserController}
 * and {@link com.bothsann.authify.admin.AdminController} depend on this interface.
 */
