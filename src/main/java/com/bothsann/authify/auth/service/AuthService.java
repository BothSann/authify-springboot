 ...
 *
 * <p>This interface is implemented by {@link com.bothsann.authify.auth.service.impl.AuthServiceImpl}.
 * Defining it as an interface allows {@link com.bothsann.authify.auth.controller.AuthController}
 * to depend on the abstraction rather than the concrete class — making each piece
